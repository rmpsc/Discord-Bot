...
class Val(commands.Cog):
    ...
    async def agent(self, ctx):
        agents = ['pick jett wdym <:tenz:760654681272877116>', 'brim baby', 'breach lol', 'gib me a corpse', 'omen diff', 'JOKE SOVA YA DED', 'bomb buddy out', 'ysas main', 'YOUR DUTY IS NOT OVAH', 'shak dart', 'viper... gg', 'zoo keeper']
